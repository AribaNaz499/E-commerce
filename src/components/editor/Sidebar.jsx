    ...
    <div className="flex flex-col bg-white p-2 gap-4 w-20 border-r border-gray-200 h-full z-[100]">
      {tools.map(tool => (
        <button
          ...
          className={`flex flex-col items-center justify-center p-2 rounded-lg transition-all ${activeTool === tool.id ? 'bg-purple-100 text-purple-600' : 'hover:bg-gray-100 text-slate-500'
            }`}
        >
          {tool.icon}
