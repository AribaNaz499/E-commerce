...
import { Save, ChevronLeft, Loader2, Monitor, Smartphone, Menu, X, Banknote } from 'lucide-react'; 
      ...
      <div className="h-auto md:h-14 bg-white border-b flex flex-col md:flex-row justify-between items-center px-4 py-2 md:py-0 z-50 shadow-sm gap-2">
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <input
            ...
            className="font-bold text-gray-800 bg-transparent border-b border-transparent focus:border-blue-300 rounded px-2 py-1 w-full md:w-48 outline-none"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-gray-50 border border-gray-200 rounded-lg px-2 py-1">
            ...
            <input
              ...
              placeholder="0.00"
              className="w-16 bg-transparent outline-none text-xs font-bold text-green-600 placeholder:text-gray-300"
            />
          </div>
