...
const UserEditDesign = () => {
  ...
  if (fetching)
    return <div className="h-screen flex items-center justify-center">Loading Design...</div>;
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
        ...
        <main className="flex-1 flex items-center justify-center bg-[#F1F5F9] relative overflow-hidden p-4 pb-24 md:pb-4">
          ...
          >
            ...
            <CanvasArea
              key={`canvas-${currentSlide}`}
              elements={elements}
              orientation={orientation}
              isLocked={isLockedSlide}
            />
