...
import { LayoutGrid, ShoppingBag, PlusSquare, Menu, X, Layers, LogOut, User, Settings } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const links = [
    ...
    { icon: <ShoppingBag size={18} />, label: "Admin Orders", path: "/admin-portal/admin-orders" },
    { icon: <User size={18} />, label: "Admin Users", path: "/admin-portal/admin-user" },
    { icon: <Settings size={18} />, label: "Settings", path: "/admin-portal/admin-setting" },
